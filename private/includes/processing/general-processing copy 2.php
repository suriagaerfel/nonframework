...
if (isset($_POST['get_site_manager_records_submit'])){
    ...
    if ($sqlRecordsResult->num_rows>0){
        ...
        echo "
        <div id='sm-records-list' style='display:flex; gap:20px;'>
        ";
        while($listRecords = $sqlRecordsResult->fetch_assoc()){
            ...
            if ($recordCategory == 'General Registration') {
                ...
                $listRecordCivilEducationalAttainment = $listRecords['registrantEducationalAttainment'];
                ...
                $listRecordBasicAccount = $listRecords['registrantBasicAccount'];
                $listRecordTeacherAccount = $listRecords['registrantTeacherAccount'];
                $listRecordWriterAccount = $listRecords['registrantWriterAccount'];
                $listRecordEditorAccount = $listRecords['registrantEditorAccount'];
                $listRecordResearchesAccount = $listRecords['registrantResearchesAccount'];
                $listRecordDeveloperAccount = $listRecords['registrantDeveloperAccount'];
                $listRecordSiteManagerAccount = $listRecords['registrantSiteManagerAccount'];
                $listRecordDataAnalystAccount = $listRecords['registrantDataAnalystAccount'];
                 $listRecordFunderAccount = $listRecords['registrantFunderAccount'];
            ...
            echo "
                <div id='".'details-for-record-'.$listRecordId."' style='margin-bottom:10px;height:fit-content; width: 350px !important; background-color:blue;gap:10px;'>
