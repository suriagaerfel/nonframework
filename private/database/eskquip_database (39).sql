...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2026 at 08:46 AM
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=985;
...
--
ALTER TABLE `website_manager_accounts`
  MODIFY `website_manager_accountId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
