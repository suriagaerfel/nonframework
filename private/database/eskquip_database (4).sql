...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2026 at 04:55 PM
...
(277, 'new app', '/public/tools/new-app/', 'developer_tools', 5, 1, 'Published', '2026-02-06 23:54:00', '', '');
...
(21, '2025-12-16 09:50:53', 'writer_articles', 130, 1, 246, '2026-02-06 11:02:11'),
...
(39, '2026-02-06 15:47:24', 'developer_tools', 5, 1, 3, '2026-02-06 15:48:07');
...
(2, 'developer_tools', 5, 1, '', '2026-02-06 15:13:17'),
(3, 'developer_tools', 5, 2, '', '2026-02-06 15:15:31'),
(4, 'developer_tools', 5, 2, '', '2026-02-06 15:15:42');
...
INSERT INTO `developer_tools` (`developer_toolId`, `developer_toolTitle`, `developer_toolCategory`, `developer_toolTags`, `sType`, `developer_toolDescription`, `developer_toolIcon`, `developer_toolOwner`, `developer_toolCreatedDate`, `developer_toolPubDate`, `developer_toolUpdateDate`, `developer_toolContentVersion`, `developer_toolStatus`, `developer_toolAccessType`, `developer_toolAmount`, `developer_toolSharedWith`, `developer_toolLink`, `developer_toolDirectory`) VALUES
(5, 'new app 2', 'Math', 'hh', '', 'sdgdgfdhfdh', '', '1', '2026-02-06 15:13:17', '2026-02-06 23:54:00', '2026-02-06 15:54:00', 5, 'Published', 'Free Access', 0, '', '/public/tools/new-app-2/', '');
...
(4, '2026-02-06 15:44:51', 5, '/public/tools/new-app-2/index.php');
...
INSERT INTO `school_researches` (`school_researchId`, `school_researchTitle`, `school_researchSlug`, `school_researchCategory`, `school_researchAbstract`, `school_researchImage`, `school_researchFormat`, `school_researchUploader`, `school_researchProponents`, `school_researchUploadDate`, `school_researchDate`, `school_researchLiveDate`, `school_researchUpdateDate`, `school_researchStatus`, `school_researchLink`, `school_researchContentVersion`) VALUES
(39, 'xcfhchgh', 'xcfhchgh', 'Correlational', 'ffdgfdg', '/uploads/thumbnails/researches/39-20251215221332.jpeg', 'pdf', 9, 'dfgfg', '2025-12-15 22:06:21', '2025-12-10', '2025-12-19 18:58:49', '2026-02-03 20:38:33', 'Published', '/uploads/documents/school/9-7863666863686768.pdf', 1),
(41, 'ffsgf', 'ffsgf', 'Correlational', 'gdsgdsgdsgdsggdsgdg', '', 'pdf', 9, 'dfggfdgg', '2026-02-04 15:09:27', '2026-03-05', '0000-00-00 00:00:00', '2026-02-04 15:16:21', 'Draft', '/uploads/documents/school/9-6666736766.pdf', 1),
(42, 'dgfdgfd', 'dgfdgfd', 'Causal-comparative', 'fgfdgfdg', '', 'pdf', 9, 'fdg', '2026-02-04 15:17:15', '2026-02-19', '0000-00-00 00:00:00', '2026-02-04 15:17:15', 'Draft', '/uploads/documents/school/9-64676664676664.pdf', 1);
...
INSERT INTO `writer_articles` (`writer_articleId`, `writer_articleTitle`, `writer_articleSlug`, `writer_articleImage`, `writer_articleCategory`, `writer_articleTopic`, `writer_articleWriterId`, `writer_articleWriterName`, `writer_articleEditors`, `writer_articleWriteDate`, `writer_articleUpdateDate`, `writer_articlePubDate`, `writer_articleContent`, `writer_articleContentVersion`, `writer_articleStatus`, `writer_articleComments`) VALUES
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=280;
...
--
ALTER TABLE `content_performance`
  MODIFY `content_viewId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `developer_tool_files`
  MODIFY `developer_tool_fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=758;
