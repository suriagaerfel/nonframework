...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2026 at 04:38 PM
...
(21, '2025-12-16 09:50:53', 'writer_articles', 130, 1, 245, '2026-02-05 15:38:23'),
...
CREATE TABLE `developer_uploaded_files` (
  ...
  `developer_uploadedFileToolId` int(11) NOT NULL,
...
INSERT INTO `developer_uploaded_files` (`developer_uploadedFileId`, `developer_uploadedFileTimestamp`, `developer_uploadedFileToolId`, `developer_uploadedFileLink`) VALUES
...
(41, '2026-02-05 15:35:22', 6, '/public/tools/erfel-app/index.php');
...
--
ALTER TABLE `developer_uploaded_files`
  MODIFY `developer_uploadedFileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=735;
