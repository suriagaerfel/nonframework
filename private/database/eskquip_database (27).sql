...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2026 at 09:42 AM
...
(6, '2026-02-16 06:21:27', 'Teacher File', 77, 1, 10, 1, 'GCash', 'dsgdgdh', 'Pending', '/uploads/content-purchase/proof/userid-1-20260216142127.jpeg');
...
--
ALTER TABLE `content_categories`
  MODIFY `content_categoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `content_purchase`
  MODIFY `content_purchaseId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=926;
