...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2026 at 01:45 PM
...
(20, 'teacher_files', 81, 'Draft', '0000-00-00 00:00:00'),
...
(81, 'gghdg', 'gghdg', 'Test Paper', '', 'Free Access', '', 'fdgfgfdgfdhdfhdfh', 1, '', 'pdf', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2026-02-13 19:19:32', 'Draft', 'Not for Sale', 0, '/uploads/documents/teacher/files/1-6767686467.pdf');
...
--
ALTER TABLE `contents`
  MODIFY `contentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `content_categories`
--
ALTER TABLE `content_categories`
  MODIFY `content_categoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `content_tags`
  MODIFY `content_tagId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `content_versions`
--
ALTER TABLE `content_versions`
  MODIFY `content_versionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=833;
...
--
ALTER TABLE `teacher_files`
  MODIFY `teacher_fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT for table `writer_articles`
--
ALTER TABLE `writer_articles`
  MODIFY `writer_articleId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
COMMIT;
