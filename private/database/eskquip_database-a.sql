...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2026 at 08:12 AM
...
CREATE TABLE `messages` (
  ...
  `messageThread` varchar(100) NOT NULL,
  `messageRegistrantId` int(11) NOT NULL,
  `messageRegistrantAccountName` varchar(250) NOT NULL,
  `messageParticipants` varchar(100) NOT NULL,
...
INSERT INTO `messages` (`messageId`, `messageType`, `messageThread`, `messageRegistrantId`, `messageRegistrantAccountName`, `messageParticipants`, `messageContent`, `messageTimestamp`) VALUES
(1, 'Personal', '20260000042720152026000004272015', 18, '', '', 'fgggg', '2026-02-24 07:00:10'),
(2, 'Personal', '20260000042720152026000004271998', 18, '', '', 'fgggg', '2026-02-24 07:00:26'),
(3, 'Personal', '20260000042719982026000004272015', 1, '', '', 'xgfdg', '2026-02-24 07:10:08');
...
CREATE TABLE `message_threads` (
  ...
  `message_threadType` varchar(100) NOT NULL,
  `message_threadParticipants` varchar(100) NOT NULL,
...
INSERT INTO `message_threads` (`message_threadId`, `message_threadCode`, `message_threadType`, `message_threadParticipants`, `message_threadTimestamp`, `message_threadUpdateDate`) VALUES
(0, '20260000042720152026000004272015', 'Personal', '', '2026-02-24 06:59:28', '2026-02-24 07:10:08'),
(0, '20260000042720152026000004271998', 'Personal', '', '2026-02-24 07:00:26', '2026-02-24 07:10:08');
...
(40, '', 'na', '', 'na', 'Sariksyon', '', 'School', 1, '', '', '0000-00-00', 'na', '', '', '', '', '', '', '', '', '', '', '', 'sariksyon@gmail.com', '', 'sariksyon', '$2y$10$4T1LkuUwqCapHT0m3NMQeONwkqWpHHgtDSeH7AmfK6Zxo3.shkJ.y', '', 'Junior High School', '', '', '', '', '', '', 'Unverified', 'Kept', '2026-01-08 20:38:18', '50fa7dfa49c70d4f94b73a9fd364fe7ef7406a041141706139d25e24e39a787d', '2026-02-24 13:03:32', '', '', '', '', ''),
...
--
ALTER TABLE `registrant_activities`
  MODIFY `registrant_activityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1015;
